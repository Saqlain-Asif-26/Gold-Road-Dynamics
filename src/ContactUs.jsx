...
function ContactUs() {
  return (
    <div className='relative max-w-5/6 mx-auto my-6 md:my-8 lg:my-16 cursor-default bg-[#FCD151] rounded-tl-[80px] rounded-br-[80px] rounded-tr-[40px] rounded-bl-[40px] overflow-hidden'>
        <img className='absolute top-0 left-0' src="/Gold-Road-Dynamics/images/isolation-pic.png" alt="isolation-pic" />
        ...
        <img className='block sm:hidden lg:block absolute bottom-0 right-0 rotate-180' src="/Gold-Road-Dynamics/images/isolation-pic.png" alt="isolation-pic" />
    </div>
  )
}
