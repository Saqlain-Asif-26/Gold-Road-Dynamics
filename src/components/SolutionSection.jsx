...
function SolutionSection() {
  return (
    <div className='max-w-5/6 mx-auto my-4 md:my-6 py-8 sm:py-12 flex flex-col items-center cursor-default'>
        ...
        <div className='bg-[linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url("src/assets/images/solution-bg.jpg")] bg-cover bg-right sm:bg-center flex flex-col items-center rounded-2xl'>
            <img className='py-32 sm:py-44 md:py-52' src="src/assets/images/solution-icon.png" alt="solution-icon" />
